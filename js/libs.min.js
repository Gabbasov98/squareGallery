...
!function(r){r.fn.jloupe=function(o){var t,e,s={width:200,height:200,margin:6,cursorOffsetX:10,cursorOffsetY:10,radiusLT:0,radiusLB:100,radiusRT:100,radiusRB:100,borderColor:"#999",backgroundColor:"#ddd",image:!1,repeat:!1,fade:!0,fadeIn:200,fadeOut:100};return o&&(r.extend(s,o),o.hasOwnProperty("color")&&(s.borderColor=s.backgroundColor=o.color)),t=r("<div />").addClass("thejloupe").css({position:"absolute",width:s.width+"px",height:s.height+"px",backgroundColor:s.borderColor}).hide().appendTo("body"),s.borderColor||t.css("backgroundColor","none"),s.repeat?t.css("backgroundRepeat","repeat"):t.css("backgroundRepeat","no-repeat"),e=r("<div />").addClass("thejloupeview").css({width:s.width-2*s.margin+"px",height:s.height-2*s.margin+"px",backgroundRepeat:"no-repeat",marginLeft:s.margin+"px",marginTop:s.margin+"px"}).appendTo(t),s.backgroundColor&&e.css("backgroundColor",s.backgroundColor),s.image&&t.css("backgroundImage","url("+s.image+")"),r(e).css("border-top-left-radius",s.radiusLT).css("border-bottom-left-radius",s.radiusLB).css("border-bottom-right-radius",s.radiusRB).css("border-top-right-radius",s.radiusRT).css("-moz-border-radius-topleft",s.radiusLT).css("-moz-border-radius-bottomright",s.radiusRB).css("-moz-border-radius-bottomleft",s.radiusLB).css("-moz-border-radius-topright",s.radiusRT),s.image&&!s.repeat||r(t).css("border-top-left-radius",s.radiusLT).css("border-bottom-left-radius",s.radiusLB).css("border-bottom-right-radius",s.radiusRB).css("border-top-right-radius",s.radiusRT).css("-moz-border-radius-topleft",s.radiusLT).css("-moz-border-radius-bottomright",s.radiusRB).css("-moz-border-radius-bottomleft",s.radiusLB).css("-moz-border-radius-topright",s.radiusRT),r(this).each((function(){var o=r(this).data("original"),t=r(this).parent("a").attr("href"),e=r(this).attr("src"),s=o||t||e,d=r("<img />").attr("src",s);r(this).data("zoom",d)})).on("mousemove",(function(o){var d,a,i,u,c=r(this).offset(),n=r(this).data("zoom"),p=0,h=0;o.pageX||o.pageY?(p=o.pageX,h=o.pageY):(o.clientX||o.clientY)&&(p=o.clientX+document.body.scrollLeft+document.documentElement.scrollLeft,h=o.clientY+document.body.scrollTop+document.documentElement.scrollTop),r(t).offset({top:h+s.cursorOffsetY,left:p+s.cursorOffsetX}),d=r(n).prop?r(n).prop("width"):r(n).attr("width"),a=r(n).prop?r(n).prop("height"):r(n).attr("height"),i=(p-c.left)/this.width*d*-1+s.width/2.5,u=(h-c.top)/this.height*a*-1+s.height/2.5,r(e).css("backgroundImage","url("+r(n).attr("src")+")").css("backgroundPosition",i+"px "+u+"px")})).on("mouseleave",(function(){r(t).stop(!0,!0),s.fade?r(t).fadeOut(s.fadeOut):r(t).hide()})).on("mouseenter",(function(){r(t).stop(!0,!0),s.fade?r(t).fadeIn(s.fadeIn):r(t).show()})),this},r((function(){r(".jLoupe, .jloupe").jloupe()}))}(jQuery);
